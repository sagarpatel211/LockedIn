...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-gray-600 data-[state=unchecked]:bg-gray-300 dark:data-[state=checked]:bg-gray-300 dark:data-[state=unchecked]:bg-gray-700",
      className
    )}
    {...props}
    ref={ref}
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-sm bg-gray-50 dark:bg-gray-900 shadow-lg transition-transform",
